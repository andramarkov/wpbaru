...
/* Slider Section */
	$wp_customize->add_section( 'slider_section' , array(
		...
		// $wp_customize->add_setting( 'agencyup_slider_align', array(
		// 	'default'           => 'start', 
		// ) );
	
		// $wp_customize->add_control( 'agencyup_slider_align', array(
		// 	'type'     => 'radio',
		// 	'label'           => esc_html__( 'Slider Text Alignment', 'icyclub' ),
		// 	'section'         => 'slider_section',
		// 	'choices'         => array(
		// 		'start'  => esc_html__( 'Start', 'icyclub' ),
		// 		'center' => esc_html__( 'Center', 'icyclub' ),
		// 		'end' => esc_html__( 'End', 'icyclub' ),
		// ) ) );
