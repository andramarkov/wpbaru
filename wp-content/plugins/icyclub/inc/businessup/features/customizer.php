...
function icycp_businessup_register_service_section_partials( $wp_customize ){
	...
	$wp_customize->selective_refresh->add_partial( 'businessup_service_title', array(
		'selector'            => '.businessup-section .businessup-heading h3',
	...
	$wp_customize->selective_refresh->add_partial( 'businessup_service_subtitle', array(
		'selector'            => '.businessup-section .businessup-heading p',
	...
	$wp_customize->selective_refresh->add_partial( 'service_one_title', array(
		...
		'render_callback'  => 'icycp_businessup_service_one_title_render_callback',
	...
	$wp_customize->selective_refresh->add_partial( 'service_one_description', array(
		...
		'render_callback'  => 'icycp_businessup_service_one_desc_render_callback',
	
	) );
	$wp_customize->selective_refresh->add_partial( 'ser_one_btn_text', array(
		'selector'            => '.service-one a',
		'settings'            => 'ser_one_btn_text',
		'render_callback'  => 'icycp_businessup_service_one_btn_render_callback',
	...
	$wp_customize->selective_refresh->add_partial( 'service_two_title', array(
		...
		'render_callback'  => 'icycp_businessup_service_two_title_render_callback',
	...
	$wp_customize->selective_refresh->add_partial( 'service_two_description', array(
		...
		'render_callback'  => 'icycp_businessup_service_two_desc_render_callback',
	
	) );
	$wp_customize->selective_refresh->add_partial( 'ser_two_btn_text', array(
		'selector'            => '.service-two a',
		'settings'            => 'ser_two_btn_text',
		'render_callback'  => 'icycp_businessup_service_two_btn_render_callback',
	...
	$wp_customize->selective_refresh->add_partial( 'service_three_title', array(
		...
		'render_callback'  => 'icycp_businessup_service_three_title_render_callback',
	...
	$wp_customize->selective_refresh->add_partial( 'service_three_description', array(
		...
		'render_callback'  => 'icycp_businessup_service_three_desc_render_callback',
	
	) );
	$wp_customize->selective_refresh->add_partial( 'ser_three_btn_text', array(
		'selector'            => '.service-three a',
		'settings'            => 'ser_three_btn_text',
		'render_callback'  => 'icycp_businessup_service_three_btn_render_callback',
...
function icycp_businessup_service_one_title_render_callback() {
	return get_theme_mod( 'service_one_title' );
}

function icycp_businessup_service_one_desc_render_callback() {
	return get_theme_mod( 'service_one_description' );
}

function icycp_businessup_service_one_btn_render_callback() {
...
function icycp_businessup_service_two_title_render_callback() {
	return get_theme_mod( 'service_two_title' );
}

function icycp_businessup_service_two_desc_render_callback() {
	return get_theme_mod( 'service_two_description' );
}

function icycp_businessup_service_two_btn_render_callback() {
	return get_theme_mod( 'ser_two_btn_text' );
}

//Service three

function icycp_businessup_service_three_title_render_callback() {
	return get_theme_mod( 'service_three_title' );
}

function icycp_businessup_service_three_desc_render_callback() {
	return get_theme_mod( 'service_three_description' );
}

function icycp_businessup_service_three_btn_render_callback() {
...
/* Testimonial Section */
	$wp_customize->add_section( 'testimonial_section' , array(
		...
		$wp_customize->add_control('testimonial_bg_overlay_enable', array(
			'label'    => __('Enable Testimonial Background Overlay Image', 'icyclub' ),
			'section'  => 'testimonial_section',
			'type' => 'checkbox',
		) );
		...
		if ( class_exists( 'businessup_Repeater_Control' ) ) {
			...
			$bussinessup_service_content_default_value_control = $wp_customize->get_setting( 'businessup_testimonial_content' );
					if ( ! empty( $bussinessup_service_content_default_value_control ) ) 
					{
						...
						$defaults = array(
							...
							'image_url' => ICYCP_PLUGIN_URL .'/inc/businessup/images/client-thumb.jpg',
							),
		...
		$wp_customize->add_setting( 'testimonial_one_thumb',array('default' => ICYCP_PLUGIN_URL .'inc/businessup/images/testimonial/testi1.jpg',
		...
		$wp_customize->add_setting( 'testimonial_one_designation',array(
			...
			'label'   => __('Designaton','icyclub'),
			'section' => 'testimonial_section',
			'type' => 'text',
			));
		
		//testimonial two image
		$wp_customize->add_setting( 'testimonial_two_thumb',array('default' => ICYCP_PLUGIN_URL .'inc/businessup/images/testimonial/testi2.jpg',
		'sanitize_callback' => 'esc_url_raw', 'transport'         => $selective_refresh,));
		...
		'default' => __('Williams Moore','businessup'),
		'sanitize_callback' => 'icycp_businessup_home_page_sanitize_text',
		'transport'         => $selective_refresh,
		));	
...
function icycp_businessup_register_testimonial_section_partials( $wp_customize ){
	...
	$wp_customize->selective_refresh->add_partial( 'businessup_testimonials_title', array(
		'selector'            => '.testimonials-section .businessup-heading h3',
	...
	$wp_customize->selective_refresh->add_partial( 'testimonial_one_title', array(
		...
		'render_callback'  => 'icycp_businessup_testimonial_one_title_render_callback',
	
	) );
	
	$wp_customize->selective_refresh->add_partial( 'testimonial_one_desc', array(
		'selector'            => '.testimonial-one .testimonials_qute .sub-qute .context p',
		'settings'            => 'testimonial_one_desc',
		'render_callback'  => 'icycp_businessup_testimonial_one_desc_render_callback',
	
	) );
	
	$wp_customize->selective_refresh->add_partial( 'testimonial_one_name', array(
		'selector'            => '.testimonial-one .testimonials_qute .ti-client-info .user-title',
		'settings'            => 'testimonial_one_name',
		'render_callback'  => 'icycp_businessup_testimonial_name_render_callback',
	
	) );
	
	$wp_customize->selective_refresh->add_partial( 'testimonial_one_designation', array(
		'selector'            => '.testimonial-one .ti-client-info .user-designation',
		'settings'            => 'testimonial_one_designation',
		'render_callback'  => 'icycp_businessup_testimonial_designation_render_callback',
	...
	$wp_customize->selective_refresh->add_partial( 'testimonial_two_title', array(
		...
		'render_callback'  => 'icycp_businessup_testimonial_two_title_render_callback',
	
	) );
	
	$wp_customize->selective_refresh->add_partial( 'testimonial_two_desc', array(
		'selector'            => '.testimonial-two .testimonials_qute .context p',
		'settings'            => 'testimonial_two_desc',
		'render_callback'  => 'icycp_businessup_testimonial_two_desc_render_callback',
	
	) );
	
	$wp_customize->selective_refresh->add_partial( 'testimonial_two_name', array(
		'selector'            => '.testimonial-two .testimonials_qute .ti-client-info .user-title',
		'settings'            => 'testimonial_two_name',
		'render_callback'  => 'icycp_businessup_testimonial_two_name_render_callback',
	
	) );
	
	$wp_customize->selective_refresh->add_partial( 'testimonial_two_designation', array(
		'selector'            => '.testimonial-two .ti-client-info .user-designation',
		'settings'            => 'testimonial_two_designation',
		'render_callback'  => 'icycp_businessup_testimonial_two_designation_render_callback',
...
//Testimonial One
function icycp_businessup_testimonial_one_title_render_callback() {
	return get_theme_mod( 'testimonial_one_title' );
}

function icycp_businessup_testimonial_one_desc_render_callback() {
	return get_theme_mod( 'testimonial_one_desc' );
}

function icycp_businessup_testimonial_name_render_callback() {
	return get_theme_mod( 'testimonial_one_name' );
}


function icycp_businessup_testimonial_designation_render_callback() {
	return get_theme_mod( 'testimonial_one_designation' );
}


//Testimonial two
function icycp_businessup_testimonial_two_title_render_callback() {
	return get_theme_mod( 'testimonial_two_title' );
}

function icycp_businessup_testimonial_two_desc_render_callback() {
	return get_theme_mod( 'testimonial_two_desc' );
}

function icycp_businessup_testimonial_two_name_render_callback() {
	return get_theme_mod( 'testimonial_two_name' );
}


function icycp_businessup_testimonial_two_designation_render_callback() {
